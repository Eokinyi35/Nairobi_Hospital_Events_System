                ...
                <table align="center" >
                                        ...
                                        <tr>
                                          ...
                                          require_once "connection.php";
                                           $sql = mysqli_query($conn,"SELECT * FROM eventchoice");
                                          if(!empty($sql))
                                          {
                                            ...
                                            if($row > 0 ) {
                                              ...
                                              // output data of each row
                                                while($row = $sql->fetch_assoc()) {
                                                  ...
                                                  $qry_events="SELECT COUNT(*) as num FROM registered WHERE `eventname` = '$eventname'";
                                                  $total_events = mysqli_fetch_array(mysqli_query($conn,$qry_events));
                                          ...
                                          ?>
                                            ...
                                            <form method="post" action="exportevents.php" enctype="multipart/form-data">
