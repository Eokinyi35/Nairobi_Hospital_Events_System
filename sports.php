...
$qry_sports="SELECT COUNT(*) as num FROM registered WHERE `eventname` = '$eventname'";
...
$total_sports = $total_sports['num'];
                                          ...
                                          ?>
                                            ...
                                            <form method="post" action="exportsports.php" enctype="multipart/form-data">
