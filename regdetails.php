        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Make a change.</h3>
                </div>
            </div>
            <div class="row">
...
// mysql_select_db("tnhevents")or die(mysql_error());

$payroll = $ID;

$result = mysqli_query($conn, "SELECT * FROM registered WHERE payroll = '$ID'");
										...
										if(!empty($result))
                                          {
                                            ...
                                            if($row > 0 ) {
                                              ...
                                              // output data of each row
                                                ...
                                                echo "<td>" .'<a href=editReg.php?event_id=' . $row['eventId'] . '>Edit</a> '. "</td>";
                                                }
                                                echo "</table>";
                                              }else{
