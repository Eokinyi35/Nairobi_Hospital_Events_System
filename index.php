...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">Events Admin</a>
    ...
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" action="search.php" method="GET">
      <div class="input-group">
        <input type="text" name="search" class="form-control" placeholder="Search for staff" aria-label="Search" aria-describedby="basic-addon2">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Function Pages:</h6>
          <!-- <a class="dropdown-item" href="login.html">Login</a> -->
          <a class="dropdown-item" href="register.html">Register User</a>
          <a class="dropdown-item" href="register_event.html">Register Event</a>
...
?>
                ...
                <div class="mr-5"><?php echo $total_parties;?></div>
                <div class="mr-5">Parties</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="parties.php">
...
?>
                ...
                <div class="mr-5"><?php echo $total_sports;?></div>
                <div class="mr-5">Sports Events</div>
              </div>
...
?>
                ...
                <div class="mr-5"><?php echo $total_campaigns;?></div>
                <div class="mr-5">Campaigns</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="campaigns.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
        ...
        <div class="card mb-3">
          <div class="card-header">
                ...
                Pie Chart</div>
              <div class="card-body">
                <canvas id="dashReport" width="100%" height="50">
                </canvas>
                <div class="col-md-3">
                    <?php 
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Eokinyi35 2019</span>
          </div>
        </div>
      </footer>
