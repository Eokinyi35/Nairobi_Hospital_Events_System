  ...
  <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="body.php">Back</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
             <form id ="ContactForm" action="regedit.php?event_id=<?php echo $_GET['event_id'] ?>"  method="POST" enctype ="multipart/form-data">
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                <?php
                                    ...
                                    if(isset($_GET['event_id'])){
                                        $event_id = $_GET['event_id'];
                                           $sql = mysqli_query($conn,"SELECT * FROM registered WHERE eventId = $event_id ");
                                          if(!empty($sql))
                                          {
                                ...
                                <h4 class="section-heading">Event name: <?php echo $rew["eventname"];?></h4>
                                <h5 class="section-heading">Prefered Date</h5>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <h5 class="section-heading">Mode of Transportation</h5>
                                    <select name="transportation" id="transportation">
                                        <option>Mode of transportation</option>
                                      <option value="Private">Private</option>
                                      <option value="Allocated">Institution provision</option>
                                    </select>
