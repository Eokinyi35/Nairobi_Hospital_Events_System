                                        ...
                                        $event_id = $_GET['event_id'];
                                          ...
                                          if(!empty($sql))
                                          {
                                            ...
                                            if($row > 0 ) {
                                              ...
                                              echo "<th>Date for attendance</th>";
                                              echo "<th>Contact</th>";
...
// $qry_parties="SELECT COUNT(*) as num FROM registered WHERE `eventname` = '$eventname'";
...
// $total_parties = $total_parties['num'];
                                          ...
                                          ?>
                                            ...
                                            <form method="post" action="exportdetails.php?event_id=<?php echo $_GET['event_id'] ?>" enctype="multipart/form-data">
